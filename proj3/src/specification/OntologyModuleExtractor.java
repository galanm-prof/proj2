...
public class OntologyModuleExtractor implements OntologySegmenter {
	...
	public static enum TYPEMODULE {	BOTTOM_LOCALITY, TOP_LOCALITY, BOTTOM_TOP_LOCALITY, STAR	}
	...
	/**
	 * Interface from OWLAPI OntologySegmenter. We extract by the type of module defined in constructor or
	 * Bottom module by default
	 */
	...
	private void extractModule(Set<OWLAxiom> axioms, boolean dualConcepts, boolean dualRoles){
		...
		localityChecker = new SyntacticLocalityChecker(dualConcepts, dualRoles, considerAnnotations,
