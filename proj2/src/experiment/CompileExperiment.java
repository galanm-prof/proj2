...
public class CompileExperiment extends ParserExperimentBaseVisitor<String>{
    private FileWriter f=null;
    private String path="./src/experiments/";
    ...
    private void codeGenerationImports()  {
        String code = "package experiments;\n"+
                "import common.Tuple;\n" +
    ...
    private void codeGenerationSearch(){
        try{
            ...
            if (typeOfSearch.equals("inefficient")) {
                write_blanks();
                f.write("Tuple<Set<String>,Double,Set<String>,Double> r1=searching.inefficientSearch(request);\n");
            }
            else if (typeOfSearch.equals("efficient-1-level")) {
                write_blanks();
                f.write("Tuple<Set<String>,Double,Set<String>,Double> r1=searching.efficientSearch1LevelOfAbstraction(request);\n");
            }
            else{
                write_blanks();
                f.write("Tuple<Set<String>,Double,Set<String>,Double> r1=searching.efficientSearch2LevelsOfAbstraction(request);\n");
            }
            write_blanks();
            ...
            write_blanks();
            f.write("FileWriter g = new FileWriter(\"./src/experiments/"+className+".out\");\n");
            write_blanks();
