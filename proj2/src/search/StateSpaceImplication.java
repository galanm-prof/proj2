...
public class StateSpaceImplication {
    ...
    private static final String implicationsRepository="C://xampp//htdocs//implications2//";
    private static final String stateSpaceImplicationsRepository=implicationsRepository+
            "stateSpaceImplications//";
    private static final String rewritingPath="http://127.0.0.1/rewriting2/";
    private static String rewritingRepository="c:/xampp/htdocs/rewriting2/";
    private static final String modulesPath="http://127.0.0.1/modules2/";
    ...
    private static boolean impliesState(OWLOntology state,List<OWLReasoner> reasoners){
    ...
    public static boolean preconditionsImplication(String specification,
                                                   String request) throws OWLOntologyCreationException {

        String modulePath=modulesPath+specification+"/"+request+"/";
        ...
        //System.out.println(rewritingP1Repository);
        ...
        List<OWLOntology> P1=new LinkedList<>();
        ...
        List<OWLReasoner>P2=new LinkedList<>();
        for(File f:rh2.get_files()){
            ...
            IRI iri_theory = IRI.create("http://127.0.0.1/ontologies2/theory.owl");
    ...
    public static boolean effectsImplication(String specification,
                                             String request) throws OWLOntologyCreationException {
        String modulePath=modulesPath+specification+"/"+request+"/";
        ...
        for(File f:rh1.get_files()){
            ...
            //System.out.println("E1 axioms:"+effect1.getAxioms());
            OWLOntology theory=manager.createOntology(axioms,iri_theory);
            OWLReasoner reasoner=reasonerFactory.createReasoner(theory);
    ...
    public static void readImplications() throws OWLOntologyCreationException, OWLOntologyStorageException, IOException {
        ...
        for (File n1:rh1.get_directories()) {
            ...
            String path2="C://xampp//htdocs//substitutions2//substitutionsI//"+n1.getName()+"//";
            RepositoryHandler rh2 = new RepositoryHandler(path2);
            for (File n2:rh2.get_directories()){
                System.out.println("    " + n2.getName());
                if (effectsImplication(n1.getName(), n2.getName()) &&
                        preconditionsImplication(n1.getName(), n2.getName())) {
