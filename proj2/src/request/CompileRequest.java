...
public class CompileRequest extends RequestParserBaseVisitor<Object> {
    private OWLCodeGenerator codeGenerator;
    private Entities entities=null;
    private String requestName=null;

    //For the purpose of facilitating unification activities between requests and specifications
    ...
    public void init(String name,Entities entities) throws OWLOntologyCreationException {
        requestName=name;
        this.entities=entities; //computed previously by ContextualAnalisisRequest
        ...
        String path="C://xampp//htdocs//requests//"+
                this.requestName.replace(".txt","")+"//";
    ...
    @Override
    public Object visitInputs(RequestParser.InputsContext ctx) {
        if (ctx.iparams()!=null)
        ...
        //write in an auxiliary file both the name and the type of an input parameter under consideration.
        ...
        IRI I_IRI_server = IRI.create("http://127.0.0.1/requests/"+
                this.requestName.replace(".txt","")+"/I.owl");
        IRI I_IRI = IRI.create("file:///C://xampp//htdocs//requests//"+
                this.requestName.replace(".txt","")+"//I.owl");
        try {
    ...
    @Override
    public Object visitIparams(RequestParser.IparamsContext ctx) {
    ...
    @Override
    public Object visitIparam(RequestParser.IparamContext ctx) {
    ...
    @Override
    public Object visitOutputs(RequestParser.OutputsContext ctx) {
        if (ctx.oparams()!=null)
        ...
        fh.close_file();
        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        IRI O_IRI_server = IRI.create("http://127.0.0.1/requests/"+
                this.requestName.replace(".txt","")+"/O.owl");
        IRI O_IRI = IRI.create("file:///C://xampp//htdocs//requests//"+
                this.requestName.replace(".txt","")+"//O.owl");
        try {
    ...
    @Override
    public Object visitOparams(RequestParser.OparamsContext ctx) {
    ...
    @Override
    public Object visitOparam(RequestParser.OparamContext ctx) {
        //iparam : type  ID          type: ID COLON ID
        String parameter = ctx.ID().getText();
        String type = ctx.type().ID(1).getText();
    ...
    @Override
    public Object visitPairs_of_states(RequestParser.Pairs_of_statesContext ctx) {
        //(pair_of_states)+
        ...
        if (E.size()>1){
            for(int i=0;i<E.size();i++){
                IRI P_IRI_server = IRI.create("http://127.0.0.1/requests/"+
                        this.requestName.replace(".txt","")+"/P"+i+".owl");
                IRI E_IRI_server = IRI.create("http://127.0.0.1/requests/"+
                        this.requestName.replace(".txt","")+"/E"+i+".owl");
                IRI P_IRI = IRI.create("file:///C://xampp//htdocs//requests//"+
                        this.requestName.replace(".txt","")+"//P"+i+".owl");
                IRI E_IRI = IRI.create("file:///C://xampp//htdocs//requests//"+
                        this.requestName.replace(".txt","")+"//E"+i+".owl");
                try {
            ...
            IRI P_IRI_server = IRI.create("http://127.0.0.1/requests/"+
                    this.requestName.replace(".txt","")+"/P.owl");
            IRI E_IRI_server = IRI.create("http://127.0.0.1/requests/"+
                    this.requestName.replace(".txt","")+"/E.owl");
            IRI P_IRI = IRI.create("file:///C://xampp//htdocs//requests//"+
                    this.requestName.replace(".txt","")+"//P.owl");
            IRI E_IRI = IRI.create("file:///C://xampp//htdocs//requests//"+
                    this.requestName.replace(".txt","")+"//E.owl");
    ...
    @Override
    public Object visitPair_of_states(RequestParser.Pair_of_statesContext ctx) {
    ...
    @Override
    public Object visitPrecondition(RequestParser.PreconditionContext ctx) {
    ...
    @Override
    public Object visitEffect(RequestParser.EffectContext ctx) {
    ...
    @Override
    public Object visitSentences(RequestParser.SentencesContext ctx) {
    ...
    @Override
    public Object visitSentence(RequestParser.SentenceContext ctx) {
    ...
    @Override
    public Object visitSet(RequestParser.SetContext ctx) {
        //set :  set_and OR set
        //    |  set_and
    ...
    @Override
    public Object visitSet_and(RequestParser.Set_andContext ctx) {
    ...
    @Override
    public Object visitSet_base(RequestParser.Set_baseContext ctx) {
    ...
    @Override
    public Object visitProperty_set(RequestParser.Property_setContext ctx) {
    ...
    @Override
    public Object visitNeg_set(RequestParser.Neg_setContext ctx) {
        //neg_set : NEG set  ;
    ...
    @Override
    public Object visitInv_property_set(RequestParser.Inv_property_setContext ctx) {
    ...
    public Object visitInv_property(RequestParser.Inv_propertyContext ctx, Stack<Boolean> b) {
    ...
    @Override
    public Object visitClass_set(RequestParser.Class_setContext ctx) {
        //class_set :  ID
        //          | THING
        //          | NOTHING
        OWLClassExpression ce = null;
    ...
    @Override
    public Object visitAnonymous_set(RequestParser.Anonymous_setContext ctx) {
    ...
    @Override
    public Object visitTerms(RequestParser.TermsContext ctx) {
    ...
    @Override
    public Object visitSet1(RequestParser.Set1Context ctx) {
        //set1: class_set
        //      | OP set CP
        //      | OB terms CB
        OWLClassExpression ce = null;
