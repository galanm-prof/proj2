...
public class CheckSpecificationConsistency {
    ...
    //Check consistency wrt vocabulary.owl
    public static List<Boolean> checkConsistency(String specificationName) throws OWLOntologyCreationException {
        List<Boolean> consistency = new LinkedList<>();

        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        String repository = "c://xampp//htdocs//specifications//"+
        ...
        System.out.println("Checking the consistency of " + specificationName + ":");
    ...
    //Check consistency wrt modules
    public static List<Boolean> checkModuleConsistency(String specificationName) throws OWLOntologyCreationException {
        List<Boolean> consistency = new LinkedList<>();
