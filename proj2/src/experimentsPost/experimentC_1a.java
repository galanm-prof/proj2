...
public class experimentC_1a{
    ...
    private static void initRequests(){
     ...
     private static void search(Set<String>repositories) throws IOException, OWLOntologyCreationException {
         ...
         for(String repository:repositories){
             ...
             for(String request:requests){
                 Tuple<Set<String>,Double,Set<String>,Double> r1=searching.inefficientSearchPost(request);
         ...
         FileWriter g = new FileWriter("./src/experimentsPost/experimentC_1a.out");
     ...
     private static boolean experiment() throws IOException, OWLOntologyCreationException {
         boolean r = false;
         Tuple2<Boolean,Set<String>> tuple=experimentC_1a.selectionOfRepositories();
         if (!tuple.getField1()) {
             System.out.println("Before generating repositories: "+tuple.getField2().size()+"/"+nRepositories);
             boolean b=experimentC_1a.generateRepositories();
             System.out.println("Generation of repositories: "+b);
         }
         initRequests();
         tuple = experimentC_1a.selectionOfRepositories();
         r = tuple.getField1();
         if (r)
             experimentC_1a.search(tuple.getField2());
         return r;
     }
     public static void main(String[]args){
         try {
             boolean r=experimentC_1a.experiment();
